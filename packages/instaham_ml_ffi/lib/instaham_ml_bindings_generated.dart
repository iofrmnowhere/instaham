...
typedef _CreateNative = Int32 Function(
    Pointer<Utf8>, Pointer<Pointer<InstahamMlContext>>);
...
class InstahamMlBindings {
  ...
  InstahamMlBindings(this._lib)
      : _create = _lib.lookupFunction<_CreateNative, _CreateDart>(
        ...
        _segment = _lib.lookupFunction<_InferNative, _InferDart>(
          'instaham_ml_segment_json',
        ),
  ...
  (MlStatus, String) segment(
    Pointer<InstahamMlContext> ctx,
    String imagePath,
  ) =>
      _invoke(_segment, ctx, imagePath);
